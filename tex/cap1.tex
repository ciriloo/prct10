...
%---------------------------------------------------------------------------------
\section{Sección Uno: Descripción del número $\Pi$}
\label{1:sec:1}
  $\Pi$(pi) es la relación entre la longitud de una circunferencia y su diámetro, en geometría
  euclidiana. Es un número irracional y una de las constantes matemáticas más importantes. Se emplea frecuentemente en matemáticas, física e ingeniería. El valor numérico de $\Pi$, truncado a sus primeras cifras, es el siguiente:
...
\subsection{subsección 1: Nombre del numero $\Pi$}
\label{1:subsec:1}
...
%---------------------------------------------------------------------------------
\section{Sección Dos: Definiciones del numero $\Pi$}
\label{1:sec:2}

\subsection{Sección Dos: Definiciones del numero $\Pi$}
\label{1:subsec:2}
  Definición:\\
    las más común es:\\
...
Por tanto, también $\Pi$ es: \\
   ...
   Además es un número irracional y trascendente;  \\
...
También se sabe que $\Pi$ tampoco es un número de Liouville (Mahler,16 1953), es decir, no sólo es trascendental sino que no puede ser aproximado por una secuencia de racionales "rápidamente convergente".
